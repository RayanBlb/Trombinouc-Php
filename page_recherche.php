...
<body>
	...
	if (isset($_GET['message'])){
		if($_GET['message'] == 1 ){
			$msg = "Veuiller remplir les champs Nom et Prenom !";
		}elseif($_GET['message'] == 2 ){
			$msg = "Votre demande d'amis a bien été prise en compte !";
		}elseif($_GET['message'] == 3 ){
			$msg = "La personne que vous avais rechercher n'existe pas !";
		}
		...
		echo"</script>";
 			...
 			<article>
				...
				<section class="formulaire-connexion">
 					<form action="./outils/add-recherche.php" method="POST">

								<h2>Rechercher un autre utilisateur</h2>
								...
								<br>
								<br>
								<input type="text" id="prenom" name="prenom_recherche">
								<br>

								<label for="nom">Nom : </label>
								<br>
								<br>
								<input type="text" id="nom" name="nom_recherche">
								<br>
							</div>
				...
				<?php include('./outils/recherche-utilisateur.php'); ?>
			</article>
	</body>
</html>
<?php
